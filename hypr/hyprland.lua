...
hl.bind("XF86AudioPlay",  hl.dsp.exec_cmd("my-touchbar-controller media play-pause"), { locked = true })
hl.bind("XF86AudioNext",  hl.dsp.exec_cmd("my-touchbar-controller media next"),        { locked = true })

-- sysmenu
hl.bind("SUPER + ALT + SPACE", hl.dsp.exec_cmd("~/.local/bin/sys-menu"))
