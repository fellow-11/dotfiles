...
if [ -e /sys/bus/pci/devices/0000:03:00.1 ]; then
    echo 1 > /sys/bus/pci/devices/0000:03:00.1/remove 2>/dev/null || true
    log "Removed dGPU audio PCI device 0000:03:00.1"
fi
if [ -e /sys/bus/pci/devices/0000:03:00.0 ]; then
    echo 1 > /sys/bus/pci/devices/0000:03:00.0/remove 2>/dev/null || true
    log "Removed dGPU PCI device 0000:03:00.0"
fi
